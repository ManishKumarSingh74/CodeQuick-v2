      ...
      <div className="container mx-auto px-6 py-8 relative">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-rose-600 to-rose-500 flex items-center justify-center shadow-lg shadow-rose-500/30">
            ...
            <div>
              ...
              <p className="text-slate-400 mt-1">Remove problems from the platform</p>
            </div>
          </div>
        </div>
                ...
                <div className="p-5">
                  <div className="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <button
                      ...
                      className="px-5 py-2.5 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/30 hover:border-rose-500/50 text-rose-400 font-medium text-sm transition-all flex items-center gap-2 group/btn"
                    >
